...
static const float rootcolor[]             = COLOR(0x1e1e2eff); /* dark gray background */
static const float bordercolor[]           = COLOR(0x3c3c4cff); /* subtle border */
static const float focuscolor[]            = COLOR(0x89b4faff); /* soft blue focus */
static const float urgentcolor[]           = COLOR(0xf38ba8ff); /* muted red for urgent */
